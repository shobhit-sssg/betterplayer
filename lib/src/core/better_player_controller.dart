...
class BetterPlayerController {
  ...
  ///Enable Auto Picture in Picture mode if it's enabled.
  Future<void>? enableAutoPIP() {
    if (videoPlayerController == null) {
      throw StateError("The data source has not been initialized");
    }
    return videoPlayerController!.enableAutoPIP();
  }

  ///Enable Auto Picture in Picture mode if it's enabled.
  Future<void>? disableAutoPIP() {
    if (videoPlayerController == null) {
      throw StateError("The data source has not been initialized");
    }
    return videoPlayerController!.disableAutoPIP();
  }
